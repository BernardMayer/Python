    ...
    for line in fDsx.readlines() :
        ...
        if (bMainloop and posErrCode > 0 and posErrCode < posEqual) : 
            ...
            if (retCode) : 
                ...
                dDsx[dsjobIdentifier]["dsrecords"][dsrecordName]["err_code"].append(s)
                pass
            else :
                print(lineNumber, "Pb:", "+".join(l))
            if (bShowAll and bShowErrCode) :
                print(lineNumber, "ERR_Code :", line.strip(), TAB, " dsrecordName :", dsrecordName, " ifBloc :", dsrecordIfBloc) 
            continue
        ...
        if (bMainloop and posErrDesc > 0 and posErrDesc < posEqual) : 
            ...
            if (retCode) : 
                ...
                dDsx[dsjobIdentifier]["dsrecords"][dsrecordName]["err_desc"].append(s)
                pass
            else :
                print(lineNumber, "Pb:", "+".join(l))
            if (bShowAll and bShowErrDescription) :
                print(lineNumber, "ERR_Desc :", line.strip(), TAB, " dsrecordName :", dsrecordName, " ifBloc :", dsrecordIfBloc) 
            continue
